<template>
    ...
    <el-card shadow="hover">
      ...
      <div class="login-info">
        <p>上次登陆时间<span>2022-7-21</span></p>
        <p>上次登陆地点<span>河北</span></p>
      </div>
    </el-card>
...
export default defineComponent({
  setup(){
    ...
    const getTableList=async()=>{
      // await axios.get("https://www.fastmock.site/mock/52d95933b9530db433d6001ce9492b40/api/home/getTableData").then((res)=>{
      //   console.log(res);
    ...
    const getChartData = async () => {
      ...
      console.log(result,'dfgh');
      let res = result.orderData;
      let userRes = result.userData;
      let videoRes = result.videoData;
      orderData.xData = res.date;
      const keyArray = Object.keys(res.data[0]);
      // console.log(keyArray,'sd');
      const series = [];
